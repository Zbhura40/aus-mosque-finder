...
async function fetchAdelaideReviews() {
  console.log('Fetching Reviews for Adelaide (SA) Mosques');
  console.log('==========================================\n');
  ...
  console.log(`Found ${mosques.length} Adelaide mosques to process\n`);
