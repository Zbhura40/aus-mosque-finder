...
async function fetchBrisbaneReviews() {
  console.log('Fetching Reviews for Brisbane (QLD) Mosques');
  console.log('===========================================\n');

  // Fetch all QLD mosques with google_place_id
  ...
  console.log(`Found ${mosques.length} Brisbane mosques to process\n`);
