  ...
  return (
    <div className="min-h-screen bg-background elegant-texture">
      ...
      <main>
        ...
        {/* Imam Profiles Section */}
        <section className="py-16 bg-cream/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-islamic-black mb-4">
                Imam Profiles
              </h2>
              <p className="text-lg text-islamic-black/80 max-w-3xl mx-auto">
                Browse the leading imams serving Australian masjids near me and discover each mosque's approach to prayer times, community services, and religious guidance. Planning to find a mosque or explore the nearest mosque for prayer? These imam profiles help make your visit more welcoming.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-islamic-black mb-2 text-center">
                    Sheikh Yahya Safi
                  </h3>
                  <p className="text-sm text-islamic-black/70 mb-3">
                    Senior Imam of Lakemba Mosque with over 27 years of service, currently pursuing Ph.D. in Fiqh. President of the Fiqhi Council of Australia and author of Islamic personal development works.
                  </p>
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      <MapPin className="w-4 h-4 text-islamic-green mr-2" />
                      <span className="font-medium">Lakemba Mosque, Sydney</span>
                    </div>
                    <div className="flex items-center">
                      <ExternalLink className="w-4 h-4 text-islamic-green mr-2" />
                      <a 
                        href="https://www.lma.org.au/imams-sheikhs-bio" 
                        target="_blank" 
              ...
              <Card className="bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-islamic-black/70 mb-3">
                    Founder of United Muslims of Australia and President of Australian National Imams Council. International speaker and community leader dedicated to Islamic education and interfaith dialogue.
                  </p>
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      <MapPin className="w-4 h-4 text-islamic-green mr-2" />
                      <span className="font-medium">United Muslims of Australia, Sydney</span>
                    </div>
                    <div className="flex items-center">
                      <ExternalLink className="w-4 h-4 text-islamic-green mr-2" />
                      <a 
                        href="https://www.uma.org.au/about-sheikhs/" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-islamic-green hover:text-islamic-green/80 underline"
                      >
              ...
              <Card className="bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-islamic-black/70 mb-3">
                    Respected scholar serving Holland Park Mosque for over two decades. President of Council of Imams Queensland and member of ANIC, known for connecting with youth through engaging Islamic lectures.
                  </p>
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      <MapPin className="w-4 h-4 text-islamic-green mr-2" />
                      <span className="font-medium">Holland Park Mosque, Brisbane</span>
                    </div>
                    <div className="flex items-center">
                      <ExternalLink className="w-4 h-4 text-islamic-green mr-2" />
                      <a 
                        href="https://www.hollandparkmosque.org.au/imam-uzair/" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-islamic-green hover:text-islamic-green/80 underline"
                      >
              ...
              <Card className="bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-islamic-black/70 mb-3">
                    Order of Australia Medal recipient recognized for service to Islamic faith and multiculturalism. Community leader focused on establishing peaceful relationships between Australian Muslim and broader communities.
                  </p>
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      <MapPin className="w-4 h-4 text-islamic-green mr-2" />
                      <span className="font-medium">Australian Muslim Community</span>
                    </div>
                    <div className="flex items-center">
                      <ExternalLink className="w-4 h-4 text-islamic-green mr-2" />
                      <a 
                        href="https://www.gg.gov.au/australian-honours-and-awardsorder-australiarecipient-profiles/imam-alaa-elzokm-oam" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-islamic-green hover:text-islamic-green/80 underline"
                      >
              ...
              <Card className="bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-islamic-black/70 mb-3">
                    Dedicated Imam serving the Perth Mosque community, providing spiritual guidance and Islamic education to the Western Australian Muslim community with commitment to traditional Islamic values.
                  </p>
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      <MapPin className="w-4 h-4 text-islamic-green mr-2" />
                      <span className="font-medium">Perth Mosque, Western Australia</span>
                    </div>
                    <div className="flex items-center">
                      <ExternalLink className="w-4 h-4 text-islamic-green mr-2" />
                      <a 
                        href="https://www.aussiemuslims.net/team/imam-mohammed-shakeeb/" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-islamic-green hover:text-islamic-green/80 underline"
                      >
              ...
              <Card className="bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-islamic-black/70 mb-3">
                    Serving Imam of Preston Mosque since 2018 and member of Board of Imams Council Victoria. Marriage celebrant active in charity events, interfaith dialogue, and community mediation services.
                  </p>
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      <MapPin className="w-4 h-4 text-islamic-green mr-2" />
                      <span className="font-medium">Preston Mosque, Victoria</span>
                    </div>
                    <div className="flex items-center">
                      <ExternalLink className="w-4 h-4 text-islamic-green mr-2" />
                      <a 
                        href="https://isv.org.au/our-imam/" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-islamic-green hover:text-islamic-green/80 underline"
                      >
            ...
            <div className="text-center mt-12">
              <p className="text-sm text-islamic-black/60">
