...
const PerthMosques = () => {
  useEffect(() => {
    // Update SEO tags for Perth page
    document.title = "Find Mosques in Perth WA | Free Mosque Directory | No Ads";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Quickly find mosques in Perth WA with addresses and contact details. Use our search radius to locate the nearest masjid. Ad-free, community-built directory.");
    }
      ...
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">
            Find Mosques in Perth | Quick Mosque Directory WA | No Ads
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Find mosques near you in Perth using our search radius feature. Get directions quickly with no ads or fuss.
          </p>
        </header>

        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-primary mb-6 text-center">
            Perth Mosque Directory - Quick and Simple
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-3">Featured Perth Mosques</h3>
                <p className="text-muted-foreground mb-4">
                  Use our search to discover mosques across Perth with full contact details and addresses.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-3">Find Mosque Near Me in Perth</h3>
                <p className="text-muted-foreground mb-4">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-3">Get Directions to Perth Mosques</h3>
                <p className="text-muted-foreground mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-primary mb-6">
            How to Use Our Perth Mosque Finder
          </h2>
          <Card>
            <CardContent className="p-6">
          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="p-8">
              ...
              <p className="text-lg text-muted-foreground">
                Get directions quickly and easily to any mosque in Perth. Our search radius feature helps you find exactly what you're looking for.
              </p>
            </CardContent>
          </Card>
        </section>
