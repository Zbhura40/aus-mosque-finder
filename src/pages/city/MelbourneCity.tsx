...
import { MapPin, Phone, ExternalLink, Star, Navigation, Filter } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredMosques.map((mosque, index) => {
                  ...
                  return (
                    <Card key={mosque.id} className="rounded-xl border border-gray-200 hover:shadow-xl transition-all duration-300 bg-white">
        ...
        <section className="mb-8 bg-white rounded-xl p-8 border border-gray-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
            <Link to="/mosques-sydney" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              <Button variant="outline" size="sm" className="w-full text-sm border-gray-300 hover:bg-gray-50 rounded-lg">
                Sydney
              </Button>
            </Link>
            <Link to="/mosques-brisbane" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              <Button variant="outline" size="sm" className="w-full text-sm border-gray-300 hover:bg-gray-50 rounded-lg">
                Brisbane
              </Button>
            </Link>
            <Link to="/mosques-perth" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              <Button variant="outline" size="sm" className="w-full text-sm border-gray-300 hover:bg-gray-50 rounded-lg">
                Perth
              </Button>
            </Link>
            <Link to="/mosques-adelaide" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              <Button variant="outline" size="sm" className="w-full text-sm border-gray-300 hover:bg-gray-50 rounded-lg">
                Adelaide
              </Button>
            </Link>
